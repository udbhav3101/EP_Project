...
try
{
	...
	if(request.getParameter("btn_update")!=null) 
	{
		...
		pstmt=con.prepareStatement("update users set email=?,fullname=?,phoneno=?,username=?,psw=?,role=?,address=?,aboutme=?,year=?,semester=? where userid ='"+id+"';");  
	...
	<form method="post" name="myform"  onsubmit="return validate();">
		...
		try
		{
			...
			<tr>
				...
				<tr>
					<td>Semester</td>
					<td><input type="text" name="semester" value="<%=semester%>"></td>
				</tr>

    ...
    <div class="hero">
      <div class="container">
		...
		<div class="main">
			...
			<center>
				<h1><a href="addfaculty.jsp">Add Record</a></h1>	
			</center>
		...
		{	
			...
			pstmt=con.prepareStatement("select * from users where role='faculty'"); 
		...
		%>
				<tr>
					...
					<td><a href="updatefaculty.jsp?edit=<%=rs.getInt(1)%> ">Edit</a></td>
